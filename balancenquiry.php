...
<body>
  ...
  <form action="userauthorizedbalance.php" method="post" id="withdrawalForm">
    <div class="first">
      <ul class="breadcrumbs">
        <li><a href="index.php">Home</a></li>
        <li><a href="selectcard.php">Select Card</a></li>
        <li><a href="menu.php">Menu</a></li>
        <li class="active"><a href="#">Balance enquiry</a></li>
      </ul>
...
<script>
  ...
  document.getElementById('withdrawalForm').addEventListener('submit', function (e) {
    ...
    if (validateCredentials()) {
      ...
      xhr.open('POST', 'userauthorizedbalance.php', true);
      xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
          var response = JSON.parse(xhr.responseText);
          if (response.valid) {
            window.location.href = 'userbalance.php';
          } else {
