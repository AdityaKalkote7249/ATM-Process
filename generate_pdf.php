...
if (isset($_GET['userData'])) {
    ...
    if (isset($userData['card_number']) && strlen($userData['card_number']) > 4) {
        $userData['card_number'] = str_repeat('*', strlen($userData['card_number']) - 4) . substr($userData['card_number'], -4);
    }
